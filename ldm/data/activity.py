...
class MriActivityBase(Dataset):
    def __init__(self, data_root,stim_root,subjects, img_dim):
...
################################################################################
        ...
        self.parent_dir = flat_paths([glob.glob(data_root + subject + "/*") for subject in subjects])
    ...
    def getNamefor(self, data, train_size=0.6,valid_size=0.2,test_size=0.2):
        start = 0
